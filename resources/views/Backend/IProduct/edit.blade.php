        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{Route('iproduct.update', $iProduct->id)}}" class="form" method="POST"
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="product_name" id="product_name"
                                                value="{{ old('product_name', $iProduct->product_name) }}"
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sub_title" id="sub_title"
                                                value="{{ old('sub_title', $iProduct->sub_title) }}"
                                                class="form-control" required>
                                            @error('sub_title')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" id="description" rows="5"
                                                required>{{ old('description', $iProduct->description) }}</textarea>
                                            @error('description')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                        </div>
 ...
 <!-- Price and Category fields -->
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            <label for="price" class="form-label bold text-capitalize">Price (₹)</label>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="card">
                                                <img src="{{ asset('storage/iproduct_img/' . $image->product_img) }}"
                                                    class="product-preview-image" alt="Product Image">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            <label for="have_img" class="mb-1 bold text-capitalize">Add New
                                                Images</label>
