                ...
                <div class="feature-box feature-box-left-icon">
                    ...
                    <div class="feature-box-content">
                        <span class="d-inline-block text-dark-gray align-middle alt-font fw-500">Returning customer? <a
                                href="{{ route('login') }}" class="text-decoration-line-bottom fw-600 text-dark-gray">Click here to
                                login</a></span>
                    </div>
                </div>
            </div>
                ...
                <div class="feature-box feature-box-left-icon">
                    ...
                    <div class="feature-box-content">
                        <span class="d-inline-block text-dark-gray align-middle alt-font fw-500">Have a coupon? <a
                                href="#" class="text-decoration-line-bottom fw-600 text-dark-gray">Click here to enter
                                your code</a></span>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-7 pe-50px md-pe-15px md-mb-50px xs-mb-35px">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-20px">
                            ...
                            <input class="border-radius-4px input-small" type="text" name="first_name" aria-label="first-name" required>
                        </div>
                        <div class="col-md-6 mb-20px">
                            <label class="mb-10px">Last name <span class="text-red">*</span></label>
                            <input class="border-radius-4px input-small" type="text" name="last_name" aria-label="last-name" required>
                        </div>
                        <div class="col-12 mb-20px">
                            <label class="mb-10px">Company name (optional)</label>
                            <input class="border-radius-4px input-small" type="text" name="company_name" aria-label="company-name">
                        </div>
                        <div class="col-12 mb-20px">
                            <label class="mb-10px" for="contry1">Country <span class="text-red">*</span></label>
                            <select name="country" id="contry1" class="form-select select-small">
                        ...
                        <div class="col-12 mb-20px">
                            ...
                            <input class="border-radius-4px input-small mb-20px" type="text" name="street_address" aria-label="text" placeholder="House number and street name">
                            <input class="border-radius-4px input-small" type="text" name="apartment" aria-label="street" placeholder="Apartment,suite,unit etc. (optional)">
                        </div>
                        <div class="col-12 mb-20px">
                            <label class="mb-10px">Town / City <span class="text-red">*</span></label>
                            <input class="border-radius-4px input-small" type="text" name="city" aria-label="town" required>
                        </div>
                        <div class="col-12 mb-20px">
                        ...
                        <div class="col-12 mb-20px">
                            ...
                            <input class="border-radius-4px input-small" type="text" name="zip_code" aria-label="zip" required>
                        </div>
                        <div class="col-12 mb-20px">
                            <label class="mb-10px">Phone <span class="text-red">*</span></label>
                            <input class="border-radius-4px input-small" type="text" name="phone" aria-label="phone" required>
                        </div>
                        <div class="col-12 mb-20px">
                            <label class="mb-10px">Email address <span class="text-red">*</span></label>
                            <input class="border-radius-4px input-small" type="email" name="email" aria-label="email" required>
                        </div>
                        <!-- start tab content -->
                            ...
                            <div id="collapseFour" class="collapse">
                                <div class="row ps-30px mb-30px mt-15px">
                                    ...
                                    <div class="col-12 mb-15px">
                                        <label class="mb-10px">Company name (optional)</label>
                                        <input class="border-radius-4px input-small" type="text" name="shipping_company_name" aria-label="company-name">
                                    </div>
                                    <div class="col-12 mb-15px">
                                        <label class="mb-10px" for="contry2">Country <span
                                                class="text-red">*</span></label>
                                        <select name="shipping_country" id="contry2" class="form-select select-small">
                                            <option value="">Select a country</option>
                                            <option value="Afganistan">Afghanistan</option>
                                            <option value="Albania">Albania</option>
                                            <option value="Algeria">Algeria</option>
                                    ...
                                    <div class="col-12 mb-15px">
                                        <label class="mb-10px">Street address <span class="text-red">*</span></label>
                                        <input class="border-radius-4px input-small mb-20px" type="text" name="shipping_street_address" aria-label="street-address" placeholder="House number and street name">
                                        <input class="border-radius-4px input-small" type="text" name="shipping_apartment" aria-label="text" placeholder="Apartment,suite,unit etc. (optional)">
                                    </div>
                                    <div class="col-12 mb-15px">
                                        <label class="mb-10px">Town / City <span class="text-red">*</span></label>
                                        <input class="border-radius-4px input-small" type="text" name="shipping_city" aria-label="town">
                                    </div>
                                    <div class="col-12 mb-15px">
                                        <label class="mb-10px" for="state2">State <span
                                                class="text-red">*</span></label>
                                        <select name="shipping_state" id="state2" class="form-select select-small border-radius-4px">
                                            <option>Select a state</option>
                                        </select>
                                    </div>
                                    <div class="col-12">
                                        <label class="mb-10px">ZIP <span class="text-red">*</span></label>
                                        <input class="border-radius-4px input-small" type="text" name="shipping_zip_code" aria-label="zip">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="border-radius-4px textarea-small" name="order_notes" rows="5" cols="5" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                        </div>
                    </div>
                                ...
                                <tr class="product">
                                    <td class="product-thumbnail">
                                        <a href="demo-jewellery-store-single-product.html"
                                            class="text-dark-gray fw-500 d-block lh-initial">{{ $item->product ? $item->product->product_name : 'Unknown Product' }}
                                            x {{ $item->quantity }}</a>
                                        <span class="fs-14 d-block">Color: {{ $item->color ?: 'N/A' }}</span>
                                        <span class="fs-14 d-block">Size: {{ $item->size ?: 'N/A' }}</span>
                                    </td>
                                    <td class="product-price" data-title="Price">
                                        ₹{{ $item->product ? $item->product->price * $item->quantity : 0 }}</td>
                                </tr>
                                @endforeach

                                <tr>
                                    <th class="w-50 fw-600 text-dark-gray alt-font">Subtotal</th>
                                    <td class="text-dark-gray fw-600">₹<span id="cart-total">{{ $total }}</span></td>
                                </tr>
                                <tr class="shipping">
                                    ...
                                    <td data-title="Shipping">
                                        <ul class="p-0">
                                            <li class="d-flex align-items-center">
                                                <input id="free_shipping" type="radio" name="shipping_method" value="free_shipping" class="d-block w-auto mb-0 me-10px p-0" checked="checked">
                                                <label class="md-line-height-18px" for="free_shipping">Free shipping</label>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <input id="flat" type="radio" name="shipping_method" value="flat"
                                                    class="d-block w-auto mb-0 me-10px p-0">
                                                <label class="md-line-height-18px" for="flat">Flat: ₹50.00</label>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <input id="local_pickup" type="radio" name="shipping_method" value="local_pickup" class="d-block w-auto mb-0 me-10px p-0">
                        ...
                        <div
                            ...
                            <div class="w-100" id="accordion-style-05">
                                ...
                                <div class="heading active-accordion">
                                    <label class="mb-5px">
                                        <input class="d-inline w-auto me-5px mb-0 p-0" type="radio" name="payment_method" value="bank_transfer" checked="checked">
                                ...
                                <div class="heading active-accordion">
                                    <label class="mb-5px">
                                        <input class="d-inline w-auto me-5px mb-0 p-0" type="radio" name="payment_method" value="check_payment">
                                ...
                                <div class="heading active-accordion">
                                    <label class="mb-5px">
                                        <input class="d-inline w-auto me-5px mb-0 p-0" type="radio" name="payment_method" value="cash_on_delivery">
                                ...
                                <div class="heading active-accordion">
                                    <label class="mb-5px">
                                        <input class="d-inline w-auto me-5px mb-0 p-0" type="radio" name="payment_method" value="paypal">
...
$(document).ready(function() {
    ...
    $('input[name="shipping_method"]').on('change', function() {
        console.log("Shipping option changed:", $(this).attr('id'));
        updateCartTotal();
    });
