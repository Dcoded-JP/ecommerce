            ...
            <div class="container">
                <div class="row align-items-center pt-35px pb-35px">
                    ...
                    <div class="col-12 col-md-auto sm-mb-15px text-center text-md-start"> 
                        <a href="{{ route('index') }}" class="footer-logo"><img src="{{ asset('images/demo-fashion-store-logo-white.png') }}" data-at2x="images/demo-fashion-store-logo-white@2x.png" alt="" class="default-logo"></a>
                    </div>
                    <!-- end footer column -->
                    <!-- start footer column -->
                    <div class="col"> 
