        ...
        <div class="row">
            ...
            <div class="col-xxl-2 col-lg-3 shop-sidebar"
                ...
                <div class="mb-30px">
                    ...
                    <ul class="shop-filter category-filter fs-16">
                        ...
                        <li><a href="#" data-filter=".{{ strtolower($category->category_name) }}"><span
                                    class="product-cb product-category-cb"></span>{{ $category->category_name }}</a><span
                                class="item-qty">{{ $products->where('category_id', $category->id)->count() }}</span>
                        </li>
                        @endforeach
            ...
            <div class="col-xxl-10 col-lg-9 ps-5 md-ps-15px md-mb-60px">
                <ul class="shop-modern shop-wrapper grid-loading grid grid-4col xl-grid-3col sm-grid-2col xs-grid-1col gutter-extra-large text-center"
                    ...
                    <li class="grid-item {{ strtolower($product->category->category_name ?? '') }}">
                        <div class="shop-box mb-10px">
                            <div class="shop-image mb-20px">
                                <a href="{{ route('productDetails', $product->id) }}">
                                    @if($product->productImages->isNotEmpty())
                                    <img src="{{ asset('storage/iproduct_img/' . $product->productImages->first()->product_img) }}"
                                        alt="{{ $product->product_name }}">
                                    @else
                                    <img src="{{ asset('images/placeholder.jpg') }}" alt="{{ $product->product_name }}">
                                    @endif
                            ...
                            <div class="shop-footer text-center">
                                <a href="{{ route('productDetails', $product->id) }}"
                                    class="alt-font text-dark-gray fs-19 fw-500">{{ $product->product_name }}</a>
